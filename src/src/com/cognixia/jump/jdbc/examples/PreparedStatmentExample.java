...
public class PreparedStatmentExample {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// preparing the statement with our query
			...
			if (b) {
				System.out.println("Student with id = " + id + " is " + rs.getString("first_name")
			...
			PreparedStatement pstmt2 = 
					conn.prepareStatement("update student set credits=50 where gender=? and credits=?");
